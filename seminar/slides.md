...
```bash
git clone https://github.com/stephenangeloni/ohMyCC.git
cd oh-my-claudecode
...
**GitHub Repository**
```
github.com/stephenangeloni/ohMyCC
```

**Website & Documentation**
```
stephenangeloni.github.io/oh-my-claudecode-website
```
